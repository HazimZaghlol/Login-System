...
signinButton.addEventListener("click", function (e) {
  if (signinEmail.classList.contains("is-valid") && signinPassword.classList.contains("is-valid")) {
    signin();
  } else {
    incorrect.innerText = "All fields are required and must meet the requirements.";
    incorrect.classList.add("text-danger");
  }
});
0;
